module mastering-genkit-go/example/chapter-13/otel

go 1.24.5

require (
	github.com/firebase/genkit/go v0.7.0
	github.com/xavidop/genkit-aws-bedrock-go v1.3.0
	github.com/xavidop/genkit-opentelemetry-go v1.2.3
)
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/bedrockruntime v1.37.2 // indirect
